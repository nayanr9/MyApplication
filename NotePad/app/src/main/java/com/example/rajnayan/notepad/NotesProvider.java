package com.example.rajnayan.notepad;
...
/**
 * Created by raj.nayan on 10-03-2016.
 */
public class NotesProvider extends ContentProvider {

    private static final String AUTHORITY = "com.example.rajnayan.notepad.notesprovider";
